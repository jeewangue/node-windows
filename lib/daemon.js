...
var daemon = function (config) {
  ...
  Object.defineProperties(this, {
    ...
    maxRetries: {
      ...
      writable: false,
      configurable: false,
      value: Object.hasOwnProperty.call(config, 'maxRetries') ? config.maxRetries : null,
    },
    ...
    stoptimeout: {
      ...
      writable: false,
      configurable: false,
      value: Object.hasOwnProperty.call(config, 'stoptimeout') ? config.stoptimeout : 30,
    },
    ...
    maxRestarts: {
      ...
      writable: false,
      configurable: false,
      value: Object.hasOwnProperty.call(config, 'maxRestarts') ? config.maxRestarts : 3,
    },
    ...
    workingdirectory: {
      ...
      writable: true,
      configurable: false,
      value: Object.hasOwnProperty.call(config, 'workingDirectory') ? config.workingDirectory : process.cwd(),
    },
      ...
      value: function (dir) {
        ...
        if (this.exists) {
          ...
          if (!fs.existsSync(path.join(this.root, this._exe))) {
            this.log.warn(
              'The main executable is missing or cannot be found (' + path.join(this.root, this._exe) + ')',
            );
            missing = true;
          }
        ...
        wincmd.isAdminUser(function (isAdmin) {
          if (isAdmin) {
            ...
            if (me.user.account !== null && me.user.password !== null) {
              const _cmd = 'runas /profile /user:' + me.user.domain + '\\' + me.user.account + ' ' + cmd;
              exec(_cmd, options, callback);
